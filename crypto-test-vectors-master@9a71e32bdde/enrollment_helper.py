...
####
    ...
    print("reqPrv: " + reqPrv)
    reqPubStr = str(reqPub.output(compress=True, Ieee1609Dot2=True))
    typeStr, xStr = reqPub.output(compress=True, Ieee1609Dot2=True)

    print("typeStr: " + typeStr)
    print("reqPub: PublicVerificationKey : ecdsaNistP256 : " + reqPubStr)
...
# Let tbsData = request.tbsRequest.eca-ee.eeEcaCertRequest.tbsData
    ...
    tbsRequest = tbsRequest + ("82" if typeStr == "compressed-y-0" else "83") + xStr
    print(" tbsRequest: " + tbsRequest)
    ...
    rStr = r.output(compress=True, Ieee1609Dot2=True)[1].upper()
    print("r: (\"x-only\", " + rStr + ")")
...
####
    ...
    print("==========================================================")
    encodedPub = ("82" if typeStr == "compressed-y-0" else "83") + xStr.upper()
